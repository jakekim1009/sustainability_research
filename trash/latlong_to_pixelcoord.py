...
def returnOnlyAfrica(geotifAddr, pixelPairs):
	# Load the image dataset
	ds = gdal.Open(geotifAddr)
	# Get a geo-transform of the dataset
	gt = ds.GetGeoTransform()
	...
	for point in pixelPairs:
		...
		if IsAfrica((lat, lon)) != 1:
			pixelPairs.remove(point)
		# Add the point to our return array
 
	return pixelPairs

#pixelPairs = [[1,1], [1000,1000]]
#fileAddr = "./SVDNB_npp_20151201-20151231_75N060W_vcmcfg_v10_c201601251413.avg_rade9.tif"
#print pixelToLatLon(fileAddr, pixelPairs)